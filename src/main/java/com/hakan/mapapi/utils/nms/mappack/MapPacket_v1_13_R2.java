...
public class MapPacket_v1_13_R2 implements MapPacket {

    @Override
    public void sendPacket(Player player, ItemStack mapItem, byte[] bytes) {
        PacketPlayOutMap packet = new PacketPlayOutMap(mapItem.getDurability(), (byte) 0, false, new ArrayList<>(), bytes, 0, 0, 128, 128);
